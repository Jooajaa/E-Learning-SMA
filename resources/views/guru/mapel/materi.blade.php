                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
                    <div>
                        ...
                        <p class="text-blue-100 mt-3">
                            Kelola materi khusus untuk kelas dan mata pelajaran ini.
                        </p>
                    </div>

                    <div class="flex flex-wrap gap-3">
                        <a href="{{ route('guru.materi.create', ['guru_kelas_id' => $guruKelas->id]) }}"
                            class="bg-white text-blue-700 hover:bg-blue-50 font-bold px-5 py-3 rounded-xl transition">
                            + Tambah Materi
                        </a>
