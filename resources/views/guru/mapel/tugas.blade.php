        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
                    <div>
                        ...
                        <p class="text-green-100 mt-3">
                            Kelola tugas khusus untuk kelas dan mata pelajaran ini.
                        </p>
                    </div>

                    <div class="flex flex-wrap gap-3">
                        <a href="{{ route('guru.tugas.create', ['guru_kelas_id' => $guruKelas->id]) }}"
                            class="bg-white text-green-700 hover:bg-green-50 font-bold px-5 py-3 rounded-xl transition">
                            + Tambah Tugas
                        </a>
            ...
            @if ($tugas->isEmpty())
                <div class="bg-white border border-slate-200 rounded-2xl p-8 text-center text-slate-500 shadow-sm">
                    Belum ada tugas untuk kelas dan mata pelajaran ini.
                </div>
            @else
