    ...
    <div class="min-h-screen bg-slate-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {{-- Materi --}}
                <a href="{{ route('siswa.mapel.materi', $mapel->id) }}"
                   class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 hover:shadow-md hover:-translate-y-1 transition block">
                    ...
                    <p class="text-slate-500 text-sm mt-2">
                        Lihat materi pembelajaran untuk mata pelajaran ini.
                    </p>
                ...
                {{-- Tugas --}}
                <a href="{{ route('siswa.mapel.tugas', $mapel->id) }}"
                   class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 hover:shadow-md hover:-translate-y-1 transition block">
                    ...
                    <p class="text-slate-500 text-sm mt-2">
                        Kerjakan tugas yang diberikan guru pada mata pelajaran ini.
                    </p>
                ...
                {{-- Kuis --}}
                <a href="{{ route('siswa.mapel.kuis', $mapel->id) }}"
                   class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 hover:shadow-md hover:-translate-y-1 transition block">
                    ...
                    <p class="text-slate-500 text-sm mt-2">
                        Ikuti kuis sesuai mata pelajaran ini.
                    </p>
                ...
                {{-- Nilai --}}
                <a href="{{ route('siswa.nilai.index', ['mata_pelajaran_id' => $mapel->id]) }}"
                   class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 hover:shadow-md hover:-translate-y-1 transition block">
                    ...
                    <p class="text-slate-500 text-sm mt-2">
                        Lihat nilai tugas dan kuis pada mata pelajaran ini.
                    </p>
                ...
                {{-- Absensi --}}
                <a href="{{ route('siswa.absensi.index', ['mata_pelajaran_id' => $mapel->id]) }}"
                   class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 hover:shadow-md hover:-translate-y-1 transition block">
                    ...
                    <p class="text-slate-500 text-sm mt-2">
                        Lihat atau isi absensi untuk mata pelajaran ini.
                    </p>
