        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-gradient-to-r from-green-700 to-slate-900 rounded-3xl p-8 text-white shadow-lg mb-8">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
                    <div>
                        <p class="text-green-100 font-semibold mb-2">Manajemen Pengguna</p>
                        <h1 class="text-3xl md:text-4xl font-extrabold">
                            Data Siswa
                        </h1>
                        <p class="text-green-100 mt-3 max-w-2xl">
                            Kelola akun siswa, data NIS, status akun, dan akses siswa ke LMS SMA.
                        </p>
                    </div>

                    <div class="bg-white/15 border border-white/20 rounded-2xl p-5 min-w-[180px]">
                        <p class="text-green-100 text-sm">Total Siswa</p>
                        <p class="text-3xl font-extrabold mt-1">{{ $siswa->count() }}</p>
                    </div>
                </div>
            </div>
